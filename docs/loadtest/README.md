...
| 3 | [CCU Test](./03-ccu-test.md) | 10→200 | 7m | — | — | — | ⏳ |
| 4 | [Login Stress](./04-login-stress-test.md) | 30→100 | 4m | — | — | — | ⏳ |
| 5 | [DB Stress](./05-db-stress-test.md) | 30→100 | 4m | — | — | — | ⏳ |
| 6 | [Stress Test](./06-stress-test.md) | 50→300 | 10m | — | — | — | ⏳ |
| 7 | [Spike Test](./07-spike-test.md) | 10→200 | 3m | — | — | — | ⏳ |
| 8 | [Write Heavy](./08-write-heavy-test.md) | 20→50 | 4m | — | — | — | ⏳ |
| 9 | [Image Upload](./09-image-upload-test.md) | 10→30 | 4m | — | — | — | ⏳ |
| 10 | [Multi-Instance](./10-multi-instance.md) | varies | ~25m | — | — | — | ⏳ |
| 11 | [Soak + 무중단배포](./11-soak-test.md) | 50 | 30m | — | — | — | ⏳ |
...
## 핵심 발견 (Phase 5.1 기준)
- 모든 API p95 < 200ms — 정상 부하에서 매우 양호
- BCrypt 로그인이 가장 느린 API — 고부하 시 첫 번째 병목 예상
- Read Replica 라우팅 동작 확인 — 읽기 API p95 < 50ms
- Presigned URL 패턴 효율적 — URL 발급 42ms + S3 직접 업로드 117ms
...
- [K6 스크립트 README](../../scripts/k6/README.md) — 스크립트 설명 및 사용법
