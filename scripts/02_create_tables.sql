-- =============================================
-- 02. 테이블 생성 스크립트
-- DDL.md 스키마 기반 8개 테이블 생성
-- =============================================
-- 실행: mysql -u root -p community < 02_create_tables.sql
-- Docker: docker exec -i mysql mysql -uroot -p$MYSQL_ROOT_PASSWORD community < 02_create_tables.sql
-- =============================================
